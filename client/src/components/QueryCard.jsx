...
export default function QueryCard({ query, selectedDbms, isSelected, onClick, language }) {
  ...
  return (
    <button
      ...
      style={isSelected && isSql ? { boxShadow: '0 0 0 2px ' + DBMS_COLORS[selectedDbms] + '80' } : {}}
    >
